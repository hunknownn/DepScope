...
export default function ErdApp() {
  ...
  return (
    <div style={{ position: "fixed", inset: 0, background: "#0f172a", color: "#e2e8f0" }}>
      ...
      {/* 컨트롤 바 */}
      <div style={{
        position: "absolute", top: 56, left: 0, right: 0, height: 48,
      ...
      {/* 그래프 영역 */}
      <div style={{ position: "absolute", top: 104, left: 0, right: 0, bottom: 0 }}>
        {showEmpty ? (
          <EmptyState />
        ) : error ? (
  ...
  return (
    <div style={{
      ...
      <div style={{ fontSize: 13 }}>
        분석 대상이 빌드되어 있고 packages 화이트리스트가 올바른지 확인해 주세요.
      </div>
      <a href="#/" style={{ marginTop: 8, color: "#60a5fa", textDecoration: "underline" }}>
        ← 메인 그래프 뷰로 돌아가기
      </a>
    </div>
  );
